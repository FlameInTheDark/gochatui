...
{#if open}
	...
	>
		...
		>
			<header
				class="relative z-20 flex items-center justify-end border-b border-[var(--stroke)] bg-[var(--panel)] px-4 py-3"
			>
				<button
					aria-label={m.close()}
			...
			<div class="flex flex-1 overflow-hidden">
				<aside
					class={`w-48 flex-shrink-0 space-y-2 border-r border-[var(--stroke)] p-4 ${sidebarClass}`}
				>
