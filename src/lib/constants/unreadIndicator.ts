export const SERVER_UNREAD_BADGE_CLASSES =
        'pointer-events-none block h-8 w-[0.375rem] -translate-x-[65%] transform rounded-r-full bg-[var(--brand)] shadow-[0_0_0_2px_var(--panel-strong)] drop-shadow-[0_0_4px_rgba(0,0,0,0.35)]';
...
export const SERVER_MENTION_BADGE_CLASSES =
        'pointer-events-none absolute -bottom-1 -right-1 z-30 flex min-w-[1.25rem] items-center justify-center rounded-full border-2 border-[var(--panel-strong)] bg-[var(--danger)] px-1 text-xs font-semibold leading-none text-[var(--bg)] shadow-[0_0_0_1px_var(--panel-strong)] drop-shadow-[0_0_4px_rgba(0,0,0,0.35)]';
